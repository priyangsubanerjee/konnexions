    ...
    <div className="h-screen w-screen fixed inset-0 bg-black overflow-hidden">
      ...
      <div className="relative h-screen w-screen overflow-y-auto overflow-x-hidden scrollbar-hide">
        ...
        <img
          ...
          alt=""
        />
        <div className="h-[800px] lg:h-[1000px] w-[800px] lg:w-[1000px] absolute right-0 z-0 rounded-full bg-gradient-to-l from-[#0057FF]/60 lg:from-[#0057FF] to-transparent translate-x-[60%] blur-xl lg:blur-3xl opacity-50"></div>
        <div className="h-[600px] lg:h-[700px] w-[600px] lg:w-[700px] absolute top-[1000px] left-0 z-0 rounded-full bg-gradient-to-r from-[#B535B0]/30 lg:from-[#B535B0]/40 to-transparent -translate-x-[50%] blur-xl lg:blur-3xl"></div>
        <img
          src="/landingCalendar.png"
          className="absolute left-0 top-[1300px] h-[400px] lg:h-[400px]"
          alt=""
        />
        <div className="absolute inset-0 z-20">
          <div className="min-h-screen flex flex-col justify-center">
            <h1 className="lg:text-center text-white text-3xl lg:text-[54px] font-bold px-6">
            ...
            <p className="lg:text-center text-sm lg:text-base text-white left-7 lg:leading-[2.9] px-6 lg:px-[300px] mt-12">
